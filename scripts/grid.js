  ...
  var Grid = (function() {
    ...
    function showPreview( $item ) {
      ...
      if( typeof preview != 'undefined' ) {
        ...
        if( previewPos !== position ) {
          // if position > previewPos then we need to take the current previewÂ´s height in consideration when scrolling the window
    ...
    Preview.prototype = {
      create : function() {
        ...
        this.$href = $( '<a class="button button--charcoal" target="_blank" href="/hire.html"><span class="content"></span></a>' );
        this.$details = $( '<div class="og-details"></div>' ).append( this.$title, this.$media, this.$description, this.$href );
      ...
      update : function( $item ) {
        ...
        this.className = eldata.class;
        $('.content').html( eldata.content );
      ...
      close : function() {
        ...
        setTimeout( $.proxy( function() {
          ...
          $expandedItem.css( 'height', $expandedItem.data( 'height' ) ).on( transEndEventNames, onEndFn );
      ...
      setHeights : function() {
        ...
        var self = this,
          onEndFn = function() {
            //if( support ) {
            //self.$item.off( transEndEventNames );
            //}
        ...
        this.$item.css( 'height', this.itemHeight ).on( transEndEventNames, onEndFn );
